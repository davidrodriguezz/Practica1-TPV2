...
#include "../game/GameManagerSystem.h"
#include "../game/BulletsSystem.h"
#include "../game/AsteroidsSystem.h"
#include "../game/FighterSystem.h"
#include "../game/FighterGunSystem.h"
...
void NetworkSystem::update() {
	...
	while (SDLNet_UDP_Recv(conn_, p_) > 0) {
		...
		case _CREATE_BULLET_: {
			...
			manager_->getSystem<BulletsSystem>()->createBullet();
